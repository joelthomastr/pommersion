...
| მიზანი | ისწავლო რამე ახალი შესასწავლ ენაზე! |

## ზოგადი მიმოხილვა <a name="overview"></a>

"მოთამაშე" მიზნად ისახავს [ისწავლოს](#ideas) რამე ახალი ამ ენაზე. მაგალითად, ახალი სიტყვა, წინადადების წყობა ან აზრის გამოხატვის განსხვავებული ფორმა. გამარჯვებულია ის, ვინც მიაღწევს ამ მიზანს.
...
პომოდოროს პროცესში საუბარი ხდება მხოლოდ კონკრეტულ სასწავლო ენაზე. მოთამაშეს შეუძლია გამოიყენოს ჟესტიკულაცია, პანტომიმა, ნივთები, ნახატები და მსგავსი ხერხები საკუთარი აზრის გადმოსაცემად.

შესვენებაზე მოთაშეს შეუძლია ისაუბროს მშობლიურ ან კომუნიკაციაში დამხმარე ნებისმიერ სხვა ენაზე; შეუძლია დასვას შეკითხვა ან გამოხატოს საკუთარი აზრი თამაშის [მეთოდებთან დაკავშირებით](#techniques).

მოდერატორი ხელმძღვანელობს თამაშს და [აკონტროლებს წესებს](#starters). მისი მოვალეობაა, დაეხმაროს მოთამაშეს, ისწავლოს რამე ახალი უცხო ენაზე; სწავლის პროცესი გახადოს სასიამოვნო, სახალისო და სარგებლობის მომტანი თითოეული მოთამაშისთვის. მოდერატორის შერჩევა შესაძლებელია მოთამაშეებისგანაც.
...
## უკანა ფლანგი <a name="backstory"></a>
...
სიტყვა "პომერსია" შედგება ორი სიტყვისგან ["pomodoro"](https://en.wikipedia.org/wiki/Pomodoro_Technique) და "immersion". ეს თამაში დაგეხმარება კონკრეტული ენის სწრაფად შესწავლაში, ამ ენაზე საუბრითა და ურთიერთობით. თამაში შესაძლებელია Zoom-ის ან მსგავსი ვიდეოპროგრამის მეშვეობით.

პროგრამის შექმნის იდეა განხორციელდა ხელოვნური [ენის (PICIN) სასწავლო გვერდიდან](https://www.youtube.com/watch?v=F1LBCMWDNwo), ასევე [Where Are Your Keys?](https://whereareyourkeys.org/) და გრამატიკის სპეციალისტის [Daniel Everett](https://www.youtube.com/watch?v=sYpWp7g7XWU) მეთოდებზე დაყრდნობით.

<div style="text-align:right"><a href="#top">შემადგენლობა</a></div>

## თამაშის ეტაპები <a name="gameplay"></a>

თამაშის ხანგრძლივობაა 55 წუთი
...
დაასრულოს საუბარი დროზე ადრე, თუ ამას საჭიროდ ჩათვლის. დროის გადაჭარბების შემთხვევაში, მოდერატორი ჩამოართმევს სიტყვის უფლებას.
...
1. **გქონდეს კონკრეტული მიზანი, რა გინდა ისწავლო.** წინასწარ იფიქრე და შეარჩიე შენთვის საინტერესო საკითხი. მაგრამ არ აჰყვე ამბიციებს და არ მოინდომო ერთ ჯერზე ბევრი რამის გაგება. გახსოვდეს, ერთი ახალი რამის გაგებაც [უკვე გამარჯვებულს გხდის](#ideas).
...
3. **გამოიყენე ფანტაზიის უნარი.** პომოდოროს პროცესში, არ შეიძლება შესასწავლი ენის გარდა სხვა ენაზე საუბარი. ეს არის ერთადერთი აკრძალვა! სხვა ყველაფერი, რაც კომუნიკაციაში დაგეხმარება, დაშვებულია, იქნება ეს ჟესტიკულაცია, სახის მიმიკები, ხმების გამოცემა, პანტომიმა, [ნივთების გამოყენება](#communication) თუ სხვა რამე.

4. **დააკვირდი სხვებს.** გახსოვდეს, სხვა მოთამაშეებზე დაკვირვებითა და ყურადღებით მოსმენით ბევრი რამის სწავლა შეგიძლია.
...
ძირითადი მოვალეობაა, *თითოეულ* მოთამაშეს შეუქმნა *მხიარული და სასიამოვნო* გარემო.

1. **უნდა დარწმუნდე, რომ ყველა მოთამაშე მონაწილეობას ღებულობს** დაეხმარე მოთამაშეებს, აქტიურად იყვნენ ჩართულები და თამაშის განმავლობაში სარგებლობა მიიღონ. განსაკუთრებით ყურადღება მიაქციე მას, ვინც მორიდებულია. შეარჩიე ყველასთვის ადვილად სასაუბრო თემები.
...
4. **ეცადე, თამაში იყოს აქტიური.** თუ მოთამაშემ გადააცილა დროს, თავაზიანად დაასრულებინე სიტყვა.
...
საიდან დაიწყო? ეს მთლიანად შენზეა დამოკიდებული. იდეისთვის გადახედე შემდეგ მითითებებს:
...
| **თუ თავისუფლად შეგიძლია ისაუბრო იმის შესახებ, როგორ გაატარე დღე...** (A2) | მიმართე სახელით რომელიმე მონაწილეს. შენთვის ნაცნობი სიტყვებით შეეცადე მოჰყვე რამე ამბავს. შემდეგ ჰკითხე: "სწორად ვთქვი? გასაგებია" |
...
| **თუ თავისუფლად გამოხატავ აზრს..** (B2) | გაიხსენე, რა საკითხი გაგიძნელდა ბოლოს და ამის შესახებ თანაშემწეს ესაუბრე. |
...
-----
Version 5.2 (2) <br>&#169; 2020 Joel Thomas<br>[კომენტარები](https://docs.google.com/forms/d/e/1FAIpQLScMbxynYi-_2QWi6Afp2smonAVkPGx6LHWZGwVMsvc-JTFkBA/viewform?usp=pp_url)
